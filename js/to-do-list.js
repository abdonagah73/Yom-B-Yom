            ...
            <div class="task-item ${task.completed ? "completed" : ""}" data-id="${task.id}">
                ...
                <div class="task-details">
                    ...
                    <div class="task-meta">
                        ...
                        <span class="priority ${task.priority === "important" ? "priority-important" : "priority-normal"}">
...
function updateStats() {
    ...
    const important = tasks.filter(
        task => task.priority === "important" && !task.completed
    ).length;

    const dueToday = tasks.filter(
        task => task.deadline === getToday() && !task.completed
    ).length;
...
function loadNotes() {
    ...
    try {
        ...
        const savedNotes =
            JSON.parse(
                localStorage.getItem("yomNotesList")
            );
...
document
    ...
    .addEventListener("click", function() {
        ...
        const firstTextarea =
            notesList.querySelector(".note-input");
...
notesList.addEventListener("input", function(event) {
